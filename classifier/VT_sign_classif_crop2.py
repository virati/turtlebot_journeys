...
def crop_img(stack,num,plot=False):
    ...
    conts,heirs = cv2.findContours(th3,cv2.RETR_LIST,5)
    cnt = conts[0]
...
for ii in [6]:#range(fulltrain_g.shape[0]):
    train_gray.append(crop_img(fulltrain_g,ii,plot=True))
